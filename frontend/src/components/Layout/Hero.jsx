import BackgroundHeroImage from "../../assets/rabbit-hero.webp"
import { Link } from "react-router-dom";

const Hero = () => {
  return (
    <section className="relative">
      <img src={BackgroundHeroImage} className="w-full h-[400px] md:h-[600px] lg:h-[750px] object-cover" alt="hero image" />
